...
<html lang="en">
    ...
    <body>
        ...
        <section class="draggable-elements">
            ...
            <i class=" fa-solid fa-y draggable" draggable="true"style="color: green;" id="Y"></i>
            <i class="fa-solid fa-z draggable"draggable="true" style="color: #0923b5; " id="Z"></i>
            
            
        </section>
        <section class="droppable-elements">
            <div class="droppable" data-draggable-id="Z"><span>Z</span></div>
            <div class="droppable" data-draggable-id="Y"><span>Y</span></div>
