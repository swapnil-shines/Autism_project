...
<body style="background-color: #5ccd7c;">
    ...
    <div class="container">
        ...
        <h1 class="text-center"
            style="margin-top: 50px; margin-bottom: 50px;font-weight:bold; color:#fff;text-decoration:underline;">
          Post to Know More</h1>

        <div class="card">

            <div class="card-body">
                <div class="row"style="background-color: #bffaa5 ;">
                    <div class="col-sm-4 text-center ">


                    </div>

                    <div class="col-sm-4 text-center"style="background-color:  #bffaa5 ;">
                        <h3 class="mt-4 mb-3">Write Experience Here</h3>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group" style="width: 100%;margin-top:30px">
                                            ...
                                            style="width: 100%;height:110px"  placeholder="Type Experience Here"></textarea>
                                        </div>
                                        <div class="form-group text-center mt-4">
                                            <button type="button" class="btn main-btn" id="save_review">Submit</button>
                                        </div>
                                    </div>
                                </div>
