...
<body style="background: url('images/review.jpeg')";>
    ...
    <div class="container">
        ...
        <h1 class="text-center" style="margin-top: 100px; margin-bottom: 50px;font-weight:bold; color:linear-gradient(to right,#0f7404,#5cb917);text-decoration:underline;">Tell Us About Your Experience</h1>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-4 text-center">
                        ...
                        <button type="button" name="add_review" id="add_review" class="btn main-btn">Review</button>
                    </div>
                </div>
            </div>
        </div>
