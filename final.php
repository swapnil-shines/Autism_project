...
.write a{
  ...
  <body>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="single_card">
                <div class="profile">
                  <img
                    src="../SE Project/assets/rectangle-1-bg-ot1.png"
                    alt="cute girl"
                  />
            ...
            <div class="swiper-slide">
              <div class="single_card">
                <div class="profile">
                  <img
                    src="../SE Project/assets/rectangle-1-bg-X2d.png"
                    alt="cute girl"
                  />
            ...
            <div class="swiper-slide">
              <div class="single_card">
                <div class="profile">
                  <img
                    src="../SE Project/assets/rectangle-1-bg-cGu.png"
                    alt="cute girl"
                  />
            ...
            <div class="swiper-slide">
              <div class="single_card">
                <div class="profile">
                  <img
                    src="../SE Project/assets/rectangle-1-bg-hTb.png"
                    alt="cute girl"
                  />
            ...
            <div class="swiper-slide">
              <div class="single_card">
                <div class="profile">
                  <img
                    src="../SE Project/assets/rectangle-1-bg-9nD.png"
                    alt="cute girl"
                  />
            ...
            <div class="swiper-slide">
              <div class="single_card">
                <div class="profile">
                  <img
                    src="../SE Project/assets/rectangle-1-bg-CA9.png"
                    alt="cute girl"
                  />
            ...
            <div class="swiper-slide">
              <div class="single_card">
                <div class="profile">
                  <img
                    src="../SE Project/assets/pexels-cottonbro-studio-4100672.jpg"
                    alt=""
                  />
    ...
    <button type="button" class="write"><a href="">Write a Review</a></button>
